                                       ...
                                       <tr> 
                                        ...
                                        <tr> 
                                            <td style="word-wrap:break-word;font-size:0px;padding:25px 30px 16px;" align="left">
                                                <div style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;text-align:left;">Congratulations! <strong>{{$data['hotel_name']}}</strong>,</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="word-wrap:break-word;font-size:0px;padding:0px 30px 25px;" align="left">
                                                <div style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;text-align:left;">Your account has been activated by the admin. Enjoy using ExitVacancy.</div>
                                            </td>
                                        </tr>
                                        <tr>
