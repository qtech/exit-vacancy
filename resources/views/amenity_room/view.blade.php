...
<section class="card box-typical-full-height">
    ...
    <h5 class="m-t-lg">Add Room Amenities</h5>
    ...
    <div class="card-block">
        <h5 class="m-t-lg">Available Room Amenities</h5>
        <div class="row">
            <div class="col-sm-12">
...
function getdata(){
                ...
                if(data.status == 1)
                {
                    ...
                    `<div class="col-sm-3">
                        <section class="widget widget-simple-sm border-custom">
                            ...
                            <a data-title="Click to disable this room amenity" onclick="disableamenity(${data.room_amenity_id});" style="border-bottom:none;position:relative; top:-20px; right:-100px">
                    ...
                    `<div class="col-sm-3">
                        <section class="widget widget-simple-sm border-custom">
                            ...
                            <a data-title="Click to enable this room amenity" onclick="disableamenity(${data.room_amenity_id});" style="border-bottom:none;position:relative; top:-20px; right:-100px">
    ...
    ajx.open("GET", "{{route('getroomamenities')}}", true);
    ajx.send();
}
...
function disableamenity(id){
    ...
    ajx.open("POST", "{{route('disableroomamenity')}}", true);
    ajx.send(formdata);
}
...
function addamenity(){
    ...
    ajx.open("POST", "{{route('addroomamenity')}}", true);
