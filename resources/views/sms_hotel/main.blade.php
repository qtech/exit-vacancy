    ...
    <div class="tbl">
        <div class="tbl-row">
            <div class="tbl-cell">
                ...
                <a href="{{route('h.addsms')}}" class="btn btn-warning pull-right">Add</a>
            </div>
        </div>
    </div>
</header>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-rounded btn-danger" href="{{route('h.deletesms',['id' => $value->notification_id])}}" class="btn btn-danger">Delete</a>
                </div>
			</div>
		</div>
	</div>
