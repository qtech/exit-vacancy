                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                        <input name="amenities" id="amenities" type="text" class="form-control" value="{{$room->hoteldata->superdeluxe_room_amenity}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Price</label>
                                        <div class="col-md-10">
                                            <input name="price" id="price" type="number" class="form-control" value="{{$room->hoteldata->superdeluxe_room_price}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Rooms Available</label>
                                        <div class="col-md-10">
                                            <input name="rooms" id="rooms" type="number" class="form-control" value="{{$room->hoteldata->superdeluxe_room}}">
                                        </div>
                                    </div>
                                    <br>
                                    <a href="{{route('sd.addimages')}}" class="btn btn-warning">Add Images</a>
...
<script type="text/javascript">
    function addnotification(){
        ...
        ajx.onreadystatechange = function () {
            if (ajx.readyState == 4 && ajx.status == 200) {
                ...
                if(demo.status == 1)
                {
                    ...
                    setTimeout(function(){
                        window.location.href = "{{route('h.sd.room')}}";   
                    },1000);
                }
                else
                {
        ...
        ajx.open("PUT", "{{route('h.sd.update')}}", true);
